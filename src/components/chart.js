...
const Chart = () => {
  ...
  const vac_csv = "https://health-infobase.canada.ca/src/data/covidLive/vaccination-coverage-map.csv"
  ...
  useEffect(() => (async () => { // useEffect(async()=>{})... react complains
    await init();
  ...
  return (
    <>
      ...
      <Box width="100%" position="fixed" bottom="10px" style={{ backdropFilter: "blur(5px)" }}>
        <Container maxWidth="lg">
